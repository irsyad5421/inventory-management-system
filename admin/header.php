...
<div id="header">
    <h2 style="color: white;position: absolute">
        <a href="dashboard.html" style="color:white; margin-left: 55px; margin-top: 40px">Admin</a>
    </h2>
</div>
    ...
    <ul class="nav">
        <li class="dropdown" id="profile-messages">
            ...
            <ul class="dropdown-menu">
                <li><a href="#"><i class="icon-user"></i><b> Admin Profile</b></a></li>
                <li class="divider"></li>
...
<div id="sidebar">
    <ul>
        <li>
            <a href="dashboard.php"><i class="icon-dashboard"></i><span><b>Dashboard</b></span></a>
        </li>
        <li>
            <a href="user-details.php"><i class="icon-user"></i><span><b>IMS User Details</b></span></a>
        </li>
        <li>
            <a href="vendor-details.php"><i class="icon-group"></i><span><b>Vendor Details</b></span></a>
        </li>
        <li>
            <a href="book-details.php"><i class="icon-book"></i><span><b>Product Details</b></span></a>
        </li>
        <li>
        ...
        <li class="submenu"><a href="#"><i class="icon-bar-chart"></i><span><b>Report</b></span></a>
            <ul>
                ...
                <li><a href="bill-record.php"><b>Product Sales Report</b></a></li>
            </ul>
        </li>
    </ul>
</div>
